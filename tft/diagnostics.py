#!/usr/bin/env python3
"""
tft/diagnostics.py — patch-based + full-grid diagnostics
...
if __name__ == "__main__":
    ...
    state     = raw_ckpt["state_dict"] if "state_dict" in raw_ckpt else raw_ckpt
    state = {k.replace("net.", ""): v for k, v in state.items()}

    Cin_ckpt  = state["spatial_patch.weight"].shape[1]   # TFT kernel
...
subset  rmse_log_model  rmse_log_pers  mae_log_model  mae_log_pers  rmse_mg_model  rmse_mg_pers  mae_mg_model  mae_mg_pers  skill_log_pct  skill_mg_pct
 train        0.818606       0.892674       0.608136      0.617396       5.196589      6.298439      2.301100     2.622593       8.297276     17.494011
   val        0.788644       0.854255       0.586913      0.596557       4.732590      5.800528      2.078475     2.384271       7.680493     18.411053
  test        0.821684       0.888878       0.611380      0.624285       5.072413      6.138979      2.292054     2.639769       7.559466     17.373663
   all        0.814210       0.885994       0.605112      0.614930       5.106720      6.198111      2.263511     2.586010       8.102054     17.608440
'''